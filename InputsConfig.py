...
class InputsConfig:
    ...
    if model == 1:
        ...
        useFIFO = False  # False = fee-priority ordering (default), True = FIFO ordering
        # ////////////////////////////////////////////////////////////////////////////////////////
        ''' Halving Parameters '''
        halvingInterval = 80  # number of blocks between each reward 
        # ////////////////////////////////////////////////////////////////////////////////////////
        ''' Transaction Parameters '''
        hasTrans = True  # True/False to enable/disable transactions in the simulator
        Ttechnique = "Light"  # Full/Light to specify the way of modelling transactions
        ...
        NODES = [Node(id=0, hashPower=50), 
                 Node(id=1, hashPower=20),
                 Node(id=2, hashPower=30)]
        
        # NODES = [
        #     Node(id=0, hashPower=50), Node(id=1, hashPower=20), Node(id=2, hashPower=30),
        #     Node(id=3, hashPower=70), Node(id=4, hashPower=50), Node(id=5, hashPower=10),
        #     Node(id=6, hashPower=30), Node(id=7, hashPower=20), Node(id=8, hashPower=10),
        #     Node(id=9, hashPower=40), Node(id=10, hashPower=30), Node(id=11, hashPower=20),
        #     Node(id=12, hashPower=30), Node(id=13, hashPower=20), Node(id=14, hashPower=10),
        #     Node(id=15, hashPower=20), Node(id=16, hashPower=10), Node(id=17, hashPower=20)
        # ]
